...
import StockRoadmap from '@/components/StockRoadmap';
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#060e15] flex flex-col">
        ...
        <CourseInfoSection
          subtitle="Master Stock Trading with a Millionaire Mentor"
          title="Designed for Traders of All Levels"
          description={[
            'Achieving Proficiency in Stock Trading Made Easy with Professor Ayush Sharma as Your Mentor. Welcome to "The Real World Stocks Course.',
          ...
          infoCards={[
            {
              title: 'Why Stocks?',
              description: 'Gain control over your time and income by becoming a successful trader.',
            },
            {
              title: 'Requirements',
              description: 'Minimum monetary requirement is $2,000',
            },
          ]}
          ctaText="Join Now"
          ctaHref="/checkout"
        ...
        <FAQAccordion items={stockFaqItems} />
      </div>
      <Footer />
    </>
  );
