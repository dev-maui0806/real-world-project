...
export default function Home() {
  return (
    <>
      ...
      <main>
        {/* Hero Section */}
        <section className="relative flex flex-col items-center justify-center w-full overflow-hidden bg-[#060e15] pt-16 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-32 min-h-screen">
          {/* Background Image */}
          <div
          ...
          {/* Content Container */}
          <div className="relative z-20 flex flex-col items-center gap-6 sm:gap-8 md:gap-10 w-full max-w-6xl px-4 mx-auto">
            {/* Headings Container */}
            <div className="flex flex-col items-center space-y-4 sm:space-y-5 md:space-y-6 w-full">
              ...
              <h1
                ...
                style={{
                  ...
                  lineHeight: 'clamp(32px, 8vw, 60px)',
                  fontWeight: 400,
              ...
              {/* Subheading */}
              <h2
                className="font-sans text-white text-center"
                style={{
                  fontSize: 'clamp(20px, 5.5vw, 35px)',
                  fontWeight: 500,
                  lineHeight: 'clamp(20px, 5.5vw, 35px)',
                  fontFamily: '"General Sans", "General Sans Placeholder", sans-serif',
                  whiteSpace: 'normal',
                  userSelect: 'none',
                }}
            ...
            {/* Video Container */}
            <div className="relative w-full max-w-4xl overflow-hidden rounded-lg sm:rounded-xl md:rounded-2xl shadow-2xl" style={{ aspectRatio: '1.77239' }}>
              {/* Video Background */}
              <div className="absolute inset-0 rounded-lg sm:rounded-xl md:rounded-2xl bg-black/80 z-10" />

              {/* Video Placeholder Image */}
              <img
                src="https://framerusercontent.com/images/rNSObuTEDJtTgkiazhgBwsqaymQ.png?width=1728&height=981"
                alt="TRW Video"
                className="absolute inset-0 w-full h-full object-cover rounded-lg sm:rounded-xl md:rounded-2xl"
              />
              ...
              <iframe
                ...
                className="absolute inset-0 w-full h-full rounded-lg sm:rounded-xl md:rounded-2xl z-20"
              />
            </div>
            ...
            <div className="flex flex-col items-center w-full gap-3 sm:gap-4">
              ...
              <a
                ...
                target="_blank"
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 md:px-10 md:py-5 bg-gradient-to-r from-[#ffa930] to-[#d5aa12] rounded-lg font-bold text-black text-base sm:text-lg md:text-xl lg:text-2xl tracking-wider hover:shadow-2xl hover:shadow-yellow-500/50 transition-all duration-300 transform hover:scale-105 uppercase"
              >
                Join The Real World
              </a>

              {/* User Avatars and Text */}
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2 h-auto sm:h-8 md:h-10 mt-1 sm:mt-2">
                <img
        ...
        <section className="w-full bg-[#060e15] py-16 sm:py-24 md:py-32 px-4">
          <div className="max-w-6xl mx-auto flex flex-col gap-8 sm:gap-10 md:gap-12">
            {/* Comparison Container */}
            <div className="flex flex-col md:flex-row gap-4 sm:gap-6 justify-center items-center flex-wrap">
              ...
              <div className="flex flex-col gap-2 sm:gap-3 items-center justify-center">
                ...
                <h4 className="text-base sm:text-lg md:text-xl lg:text-2xl font-sans font-medium text-gray-500 tracking-wider line-through text-center">
                  Hustlers University
                </h4>
              </div>

              {/* Arrow Icon */}
              <div className="w-8 sm:w-10 md:w-12 h-auto hidden sm:block">
                <img
              ...
              <div className="flex flex-col gap-2 sm:gap-3 items-center justify-center relative pt-6 sm:pt-8">
                {/* Overlapping small image */}
                <div className="w-20 sm:w-24 md:w-28 lg:w-32 absolute -top-8 sm:-top-10 z-10">
                  <img
                ...
                {/* Main product image */}
                <div className="w-28 sm:w-36 md:w-40 lg:w-48">
                  <img
                ...
                {/* Label */}
                <h4 className="text-base sm:text-lg md:text-xl lg:text-2xl font-sans font-medium text-white tracking-wider text-center">
                  THE REAL WORLD
                </h4>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 sm:gap-3 items-center w-full">
              {/* Label: INTRODUCING */}
              <p className="text-sm sm:text-base md:text-lg tracking-widest text-gray-500 text-center uppercase">
                INTRODUCING
              </p>

              {/* Heading: A MASSIVE UPGRADE */}
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-sans font-bold text-white text-center leading-tight">
                A MASSIVE UPGRADE
              </h2>
            </div>

            {/* Description Content */}
            <div className="flex flex-col gap-4 sm:gap-6 items-center max-w-3xl w-full mx-auto px-4">
              {/* First paragraph */}
              <p className="text-base sm:text-lg md:text-xl text-gray-400 text-center leading-relaxed">
        ...
        <section id="features-timeline" className="bg-gradient-to-b from-[#0a111c] to-[#0f1620] py-16 sm:py-24 md:py-32">
          <div className="max-w-7xl mx-auto px-4">
            {/* Feature 1: Learn Vital Life Lessons */}
            <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8 md:gap-12 mb-16 sm:mb-20 md:mb-24">
              {/* Image Column */}
              ...
              <div className="w-full md:w-1/2 space-y-6 sm:space-y-8">
                ...
                <div className="flex items-start gap-3 sm:gap-4 md:gap-6">
                  <img
                    ...
                    alt="Learn icon"
                    className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-lg flex-shrink-0"
                  />
                  <div>
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white font-sans leading-tight">
                      Learn Vital
                      <br />
                ...
                <div className="space-y-4 sm:space-y-6 md:space-y-8">
                  {[
                    ...
                    >
                      <div className="text-[#ffb338] text-xl sm:text-2xl font-bold flex-shrink-0 mt-1">
                        {item.icon}
                      </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-6 sm:gap-8 md:gap-12 mb-16 sm:mb-20 md:mb-24">
              {/* Image Column */}
              <div className="w-full md:w-1/2 flex items-center justify-center">
                <img
                ...
                <div className="space-y-4 sm:space-y-6 md:space-y-8">
                  {[
                    ...
                    <div
                      ...
                      className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg hover:bg-white/5 transition-colors duration-300"
                    >
                      <div className="text-xl sm:text-2xl text-[#ffb338] flex-shrink-0 mt-1">{item.icon}</div>
                      <div className="flex-1">
                        <p className="text-white font-semibold text-base sm:text-lg md:text-xl">
                          {item.title}
                        </p>
            ...
            <div className="mt-16 sm:mt-20 md:mt-24 text-center">
              <a
                ...
                rel="noopener noreferrer"
                target="_blank"
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 md:px-10 md:py-5 bg-gradient-to-r from-[#ffa930] to-[#d5aa12] rounded-lg font-bold text-black text-base sm:text-lg md:text-xl lg:text-2xl tracking-wide hover:shadow-2xl hover:shadow-yellow-500/50 transition-all duration-300 transform hover:scale-105"
              >
                Join The Real World
              </a>
