export default function StudentsWinningSection() {
  ...
  return (
    <section className="relative w-full flex flex-col items-center justify-center gap-10 bg-[#060e15] py-16 md:py-20 px-8 md:px-10">
      {/* Header Section */}
      <div className="flex flex-col items-center justify-center gap-2 text-center max-w-4xl">
        <p className="text-white/50 text-lg md:text-xl font-inter tracking-widest uppercase">
          THE REAL WORLD WINS
        </p>
        <h2 className="text-white text-4xl md:text-5xl font-inter font-bold leading-tight">
          OUR STUDENTS ARE WINNING
        </h2>
      </div>

      {/* Images Grid */}
      <div className="w-full flex justify-center gap-4 max-w-6xl">
      ...
      {/* CTA Section */}
      <div className="flex flex-col items-center gap-3 mt-10 z-20">
        <a
          href="/checkout"
